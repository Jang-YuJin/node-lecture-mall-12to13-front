...
const NewItemDialog = ({ mode, showDialog, setShowDialog }) => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log('bindCnt: ', bindCnt);
    console.log('bookCnt: ', bookCnt);
    console.log('lectureVideo: ', lectureVideo);
    console.log('fileTxtbk: ', fileTxtbk);
    console.log('realTxtbkStck: ', realTxtbkStck);
    if (mode === "new") {
      //새 상품 만들기
    } else {
      // 상품 수정하기
        ...
        <div className="cs-section">
          ...
          <Row className="mb-3">
            <Col xs={12} md={6}>
              ...
              <Form.Control name="sno" disabled value={formData.sno} />
            </Col>
            <Col xs={12} md={6}>
              <Form.Label>
